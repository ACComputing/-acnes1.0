...
class AcNesEmu:
    ...
    def open_rom(self):
        ...
        # Local core currently supports mapper-0 style loading.
        # For other mappers, we rely on fceux backend for broad catalog compatibility.
        core_loaded = False
        if rom_info and rom_info["mapper"] == 0:
